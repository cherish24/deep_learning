...
class TextCNNRNN(object):
	def __init__(self, embedding_mat, non_static, num_layers, hidden_unit, sequence_length, max_pool_size,
		...
		outputs, state = tf.nn.rnn(cell, inputs, initial_state=self._initial_state, sequence_length=self.real_len)
